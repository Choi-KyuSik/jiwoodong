...
ALTER TABLE "COMPANY" ADD CONSTRAINT "PK_COMPANY" PRIMARY KEY ("CP_NO");
ALTER TABLE "COMPANY" ADD CONSTRAINT "FK_B_MEMBER_TO_COMPANY_1" 
    FOREIGN KEY ("BU_NO") REFERENCES "B_MEMBER" ("BU_NO");
ALTER TABLE "COMPANY" ADD CONSTRAINT "FK_FILE_TO_COMPANY_1" 
    FOREIGN KEY ("FL_GNO")REFERENCES "FILE" ("FL_GNO");
