...
COMMENT ON COLUMN "B_MEMBER"."BU_GENDER" IS 'M/F';

COMMENT ON COLUMN "B_MEMBER"."BU_USEYN" IS 'Y/N';
...
COMMENT ON COLUMN "U_MEMBER"."UM_GENDER" IS 'M/F';

COMMENT ON COLUMN "U_MEMBER"."UM_BIRTH" IS 'xxxx-xx-xx';

COMMENT ON COLUMN "U_MEMBER"."UM_TEL" IS 'xxx-xxxx-xxxx';

COMMENT ON COLUMN "U_MEMBER"."UM_ADDRESS" IS '주소 API';

COMMENT ON COLUMN "U_MEMBER"."UM_USEYN" IS 'Y/N';
...
COMMENT ON COLUMN "C_AGREE"."CU_AGREE" IS 'Y/N';
