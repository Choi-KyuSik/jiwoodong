...
public class UsercpDetailpageDao {
	...
	public ArrayList<UsercpDetailpageVo> companyDetail(Connection conn) {
		...
		String sql = "select c.FL_GNO, c.CP_NAME, c.CP_ADDRESS, c.CP_DTADDRESS, c.CP_OPEN_TIME, c.CP_CLOSE_TIME, c.CP_EXPLAIN,\r\n"
				+ "r.RV_NO, r.RV_CONTENT, r.RV_WRITE_DATE, r.RV_SCORE,\r\n"
				+ "b.BU_TEL\r\n"
				+ "from company c\r\n"
				+ "join review r\r\n"
				+ "on c.FL_GNO=r.FL_GNO\r\n"
				+ "join b_member b\r\n"
				+ "on r.FL_GNO=b.FL_GNO";
