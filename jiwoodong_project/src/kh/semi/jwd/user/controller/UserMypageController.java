...
//		String umId = "apple";
		...
		ArrayList<Map<String, Object>> usBkList_c = new UserService().usBkList_c(umId);
		System.out.println("bklist_r : " + bklist_r);
		System.out.println("usBkList_c : " + usBkList_c);
		...
		request.setAttribute("usBkList_c", usBkList_c);
