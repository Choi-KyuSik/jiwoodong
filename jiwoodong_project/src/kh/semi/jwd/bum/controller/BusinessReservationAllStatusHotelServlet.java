 ...
 */
@WebServlet("/allStatusHotel")
public class BusinessReservationAllStatusHotelServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusinessReservationAllStatusHotelServlet() {
        super();
...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<BumReservationVo> list = new BusinessReservationService().AllStatusHotel(date, cpNo);
