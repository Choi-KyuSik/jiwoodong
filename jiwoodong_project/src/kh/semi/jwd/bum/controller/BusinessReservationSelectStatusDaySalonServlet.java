 ...
 */
@WebServlet("/selectStatusDaySalon")
public class BusinessReservationSelectStatusDaySalonServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusinessReservationSelectStatusDaySalonServlet() {
        super();
...
//		response.setCharacterEncoding("UTF-8"); // 이건 필터가 하니까..  암튼.. gson을 쓰면 이 모든것 신경안써도 됨ㅎㅎㅎ
		...
		ArrayList<BumReservationVo> list = new BusinessReservationService().selectStatusSalon(date, cpNo, status);
