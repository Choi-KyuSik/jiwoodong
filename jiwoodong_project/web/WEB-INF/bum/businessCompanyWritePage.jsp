					...
					<!-- hidden input에 주소 url을 value로 받을거여서 같이 만듬 세트로 놔두면 편할 듯, 위에거가 파일등록 버튼 -->
							...
							<tr>
								...
								<td class="table-light"> <input type="radio"
										...
										name="cpClassify">
										<label class="form-check-label"for="k_everyday" id="k_everyday">평일만 운영해요</label> 
										<input type="radio" id="k_neveryday" value="A"
										class="form-check-input" name="cpClassify">
										<label class="form-check-label" id ="k_neveryday" for="k_neveryday" >주말까지 운영해요</label>
									<div id="k_Classify">
										...
										<div id=k_neveryday_content>				
											<div>
												<hr>										
												영업시작 시간: <input type="time" name="cpOpenTime">
												영업마감 시간: <input type="time" name="cpCloseTime">
											</div>											
										</div>
									</div></td>
								<td colspan="2" class="table-light"><span
							...
							<tr>
								...
								<td class="table-light" colspan="3">
									...
									name="cpPostcode" id="postcode"
									style="width: 200px; display: inline-block; margin:0 0 5px 10px;" value=""
									placeholder="우편번호" /> 
									<!-- 주소찾기 -->
									<input type="button"
