...
<body style="background: none;">
			...
			<div id="p_main_logo_bar">
				...
				<div id="p_main_bar">
					<ul class="nav justify-content-end" style="font-size: 1.1em;">
						...
						<li class="nav-item"><a class="nav-link" href="loginMain">사업자/사용자 로그인</a>
						</li>
					</ul>
				</div>
			</div>
    ...
    <div id="j_loginform" style="margin-bottom: 80px;">
        <p><img id="j_logo_img" alt="지우동 로고" src="https://cdn.discordapp.com/attachments/958566133752016901/972212597510275082/f030fe44b8f9a5a7.png"></p>
        <form action="AdminLogin.lo" method="post" name="loginFrm" onsubmit="return validateForm(this);">
            <div id="j_loginform2">
                <fieldset id="j_loginform3">
                    <legend style="color: #0f7bc3; font-size: large; font-weight: bolder; text-align: center; padding: 0 5px; width: 130px;">관리자 로그인</legend>
                    <div style="position: relative; height: 150px;">
							<div id="j_id_div" style="position: absolute; line-height: 30px; margin-top: 10px;">
								<label id="j_id" for="ad_id"
