        ...
        <form action="userLogin.lo" method="post" name="loginFrm" onsubmit="return validateForm(this);">
            <div id="j_loginform2">
                <fieldset id="j_loginform3" >
                    <legend style="color: #0f7bc3; font-size: large; float: none; font-weight: bolder; text-align: center; padding: 0 5px; width: 130px;">사용자 로그인</legend>
                    <div style="position: relative; height: 150px;">
							<div id="j_id_div" style="position: absolute; line-height: 30px; margin-top: 10px;">
								<label id="j_id" for="um_id"
